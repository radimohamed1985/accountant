...
@section('content')
    <style>
        ...
        .parent-box{
            ...
            height: 110px;
            background-image:linear-gradient( to right,#93f4c1,#b8cbd1);
            padding-top: 20px;
            color: #93f4c1;
            text-align: center;
        }
        ...
        .row{
            background-image:linear-gradient( to right,#93f4c1,#93f4c1,#b8cbd1);
        }
...
.cont{
    ...
    margin-bottom:30px;
        ...
        .Item-button:hover h2,.Item-button:hover h3{
             color: white;
             transform: scale(1.2)
        }
        /*  */
        .skin-black-light .main-header .navbar{
            background-image:linear-gradient( to right,#93f4c1,#93f4c1,#b8cbd1) !important;
...
border-top-color:transparent;
    ...
    <div class="row first">
            <div class="col-lg-2 Item-button ">
        ...
        <div class="col-lg-2 Item-button">
            <a href="/reports/product-sell-return-report " class="cont" >
                <h2><i class="fa fa-undo-alt fa-3x"></i></h2>
        ...
        <div class="row first">
            ...
            <div class="col-lg-2 Item-button">
                <a href="/contacts?type=customer" class="cont" >
                    <h2>
                        <img src="https://img.icons8.com/color/100/000000/group.png"/>
                    </h2>
            ...
            <div class="col-lg-2 Item-button">
                <a href="/contacts?type=supplier" class="cont" >
                    <h2><i class="fa fas fa-address-book fa-3x"></i></h2>
            ...
            <div class="col-lg-2 Item-button">
                <a href="/users" class="cont" >
                    <h2>
                        {{-- <i class="fa fas fa-users fa-3x"></i> --}}
