...
<!-- business information here -->
		...
		<p style="width: 100% !important" class="word-wrap">
			...
			<!-- customer info -->
				...
				@if(!empty($receipt_details->mobile))
						<b>@lang('lang_v1.mobile_number') : </b> {!! $receipt_details->mobile !!}
				@endif
	...
	<div class="col-xs-12">
       ...
       <p>طريقة الدفع : {{$receipt_details->payments[0]['method']}}</p>
		@endif

       <p>{{$receipt_details->shipping_charges_label}} :  {{$receipt_details->shipping_charges}}</p>
       <p>@lang('lang_v1.shipping_address') : {{$receipt_details->shipping_address}}</p>
       <p> {{$receipt_details->shipping_details_label}} : {{$receipt_details->shipping_details}}</p>
	</div>
