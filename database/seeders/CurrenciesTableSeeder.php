...
class CurrenciesTableSeeder extends Seeder
{
    ...
    //     "thousand_separator" => ",", "decimal_separator" => ".", "status"=>null,"created_at" => null , "updated_at" => null ],
    //         [ "id" => "2", "country" => "America", "currency" => "Dollars", "code" => "USD", "symbol" => '$',
    //         "thousand_separator" => ",", "decimal_separator" => ".", "status"=>null,"created_at" => null , "updated_at" => null,"status"=>1 ],
    ...
    //         "thousand_separator" => ",", "decimal_separator" => ".", "status"=>null,"created_at" => null , "updated_at" => null,"status"=>0 ],
    ...
    //         "thousand_separator" => ",", "decimal_separator" => ".", "status"=>null,"created_at" => null , "updated_at" => null ],
    //         ["id" => "134", "country" => "Bangladesh", "currency" => "Taka", "code" => "BDT", "symbol" => "৳", "thousand_separator" => ",", "decimal_separator" => ".", "status"=>null,"created_at" => null , "updated_at" => null ]
    //   ];
